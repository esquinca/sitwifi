<section id="main-slider">
    <div class="owl-carousel">
        <div class="item" style="background-image: url(slider/bg1.jpg);">
        ...
        <div class="item" style="background-image: url(slider/bg2.jpg);">
            <div class="slider-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="item" style="background-image: url(slider/bg3.jpg);">
            <div class="slider-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
